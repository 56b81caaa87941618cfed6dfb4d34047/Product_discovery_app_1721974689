...
*/
Vue.component("simple_footer_component_1721974691", {
    template: `
    <div>
        <nav class="bg-white shadow-md dark:bg-gray-800">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center">
                    <img src="./images/logo.svg" class="h-8 mr-3" alt="ProductScout Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ProductScout</span>
                </a>
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with Discover. Unearth the latest and greatest products before anyone else. Your one-stop destination for innovation.
                    </div>
                </div>
            </div>
        </footer> 
